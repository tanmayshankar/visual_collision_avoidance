...
ros::Subscriber own_vel_sub, intruder_vel_sub, own_ptam_sub;
...
//Callback to estimate pose from PTAM. 
void ptam_own_pose_callback(const geometry_msgs::PoseWithCovarianceStamped::ConstPtr own_ptam_pose)
{   geometry_msgs::PoseWithCovarianceStamped own_pose = *own_ptam_pose;
    xo = own_pose.pose.pose.position.x / STATESCALE;
    yo = own_pose.pose.pose.position.y / STATESCALE;
}
